			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="loginacct" id="loginacct_input" placeholder="请输入登陆账号">
				    <p class="help-block label label-warning" id="info_loginacct"></p>
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" name="username" id="username_input" placeholder="请输入用户名称">
				    <p class="help-block label label-warning" id="info_username"></p>
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" name="email" id="email_input" placeholder="请输入邮箱地址">
 ...
 <script type="text/javascript" src="${APP_PATH}/static/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $('#loginacct_input').blur(function(){
            	...
            	//发送异步请求验证账号是否重复
            	$.ajax({
            		url:"${APP_PATH}/permission/user/validateLoginacct",
            		type:"POST",
            		data:{
            			"loginacct":loginacct
            		},
            ...
            $('#insert_btn').click(function(){
                ...
                //验证通过后进行保存
                $.ajax({
                	url:"${APP_PATH}/permission/user/addDo",
                	type:"POST",
                	data:{
                		"loginacct":loginacct,
                		"username":username,
